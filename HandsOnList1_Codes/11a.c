...
Date:  04-04-2025  
Description: This program opens a file, duplicates the file descriptor using dup,  appends data to the file using both descriptors, and verifies  whether the file is updated correctly.  
*/  
...
int main() {
    char f_name[] = "f11_dup_test.txt";  // Predefined filename
